...
export const Button = forwardRef(function Button({ tone = buttonRecipe.defaults.tone, size = buttonRecipe.defaults.size, shape = buttonRecipe.defaults.shape, align = buttonRecipe.defaults.align, loading = false, leading, trailing, disabled, onClick, type = "button", className, children, layoutStyle, style, ...props }, ref) {
