 ...
 */
export declare function resolveKeyboardAvoidanceBehavior(platform: "ios" | "android"): KeyboardAvoidanceBehavior;
...
export declare const keyboardAvoidanceDefaults: {
    readonly offset: 12;
    readonly safeAreaBottom: 0;
};
/**
 * 키보드가 올라왔을 때 콘텐츠가 밀려야 할 거리. safe area는 **한 번만** 센다 —
 * 키보드가 떠 있으면 홈 인디케이터 여백은 키보드가 가리므로 다시 더하면 두 겹이 된다.
 */
export declare function resolveKeyboardInset(keyboardHeight: number, descriptor?: KeyboardAvoidanceDescriptor): number;
/**
...
/** 되돌릴 수 없는 일이 일어났다 — 삭제 확정, 결제 실패. */
 | "error";
export declare const hapticIntents: readonly ["selection", "success", "warning", "error"];
/**
 ...
 */
export declare function shouldPlayHaptic(input: Readonly<{
    userInitiated: boolean;
    hapticsEnabled: boolean;
    reducedMotion?: boolean;
}>): boolean;
export declare const nativePlatformBehavior: {
...
export declare const keyboardTransitionDuration: 200;
