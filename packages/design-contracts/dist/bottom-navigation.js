...
export function resolveBottomNavigationConfiguration(configuration, itemCount) {
    ...
    return {
        presentation: configuration.presentation ?? bottomNavigationRecipeDefaults.presentation,
        distribution: configuration.distribution ?? bottomNavigationRecipeDefaults.distribution,
