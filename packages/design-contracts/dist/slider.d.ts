 ...
 */
export declare function resolveSliderValue(descriptor: SliderDescriptor, candidate: number): number;
 ...
 */
export declare function resolveSliderValueFromOffset(descriptor: SliderDescriptor, offset: number, extent: number, direction: SliderDirection): number;
