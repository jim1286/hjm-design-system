...
export {
  ...
  type IconButtonSize,
  type IconButtonTone,
  type ResolvedIconButtonPresentation,
} from "./icon-button-recipe.js";
export {
...
export type {
  ...
  BottomNavigationDistribution,
  BottomNavigationPresentation,
} from "./bottom-navigation-defaults.js";
...
export const textRecipe = {
  ...
  emphasis: Record<TextEmphasis, FontWeightValue>;
};
...
export type IconTone =
  ...
  | "danger"
  | "inverse";
export type IconWeight = "regular" | "strong";
...
export const iconRecipe = {
  ...
  sizes: Record<GlyphSize, number>;
  tones: Record<IconTone, ColorReference>;
  weights: Record<IconWeight, number>;
  stroke: {
    lineCap: "round";
    lineJoin: "round";
    scaling: "proportional";
...
export const stackRecipe = {
  ...
  axes: Record<StackAxis, "column" | "row">;
  gaps: Record<StackGap, number>;
  align: readonly StackAlign[];
  justify: readonly StackJustify[];
};
...
export const linkRecipe = {
  slots: ["root", "leading", "label", "trailing"] as const,
  ...
  slots: readonly ["root", "leading", "label", "trailing"];
  defaults: { tone: LinkTone; variant: LinkVariant };
  tones: Record<LinkTone, ColorReference>;
  variants: Record<
    LinkVariant,
    {
  ...
  >;
  gap: number;
  icon: { glyph: GlyphSize; inheritsTone: true };
  states: {
...
export const selectionGroupRecipe = {
  slots: ["root", "label", "requiredIndicator", "description", "items", "error"] as const,
...
export type SelectionGroupOrientation = keyof typeof selectionGroupRecipe.orientations;
export type SelectionGroupPresentation = keyof typeof selectionGroupRecipe.orientations.vertical.gap;
...
export const searchFieldRecipe = {
  slots: ["root", "leading", "input", "trailing", "clear", "spinner"] as const,
  ...
  slots: readonly ["root", "leading", "input", "trailing", "clear", "spinner"];
  defaults: { size: SearchFieldSize; shape: "medium" | "large" | "full" };
  sizes: Record<
    SearchFieldSize,
    {
      minHeight: number;
  ...
  >;
  colors: Record<
    "background" | "content" | "placeholder" | "leading" | "clear" | "border" | "focus" | "invalid",
    ColorReference
  >;
  shapes: Record<"medium" | "large" | "full", keyof typeof radius>;
  borderWidth: number;
...
export type ChipSize = keyof typeof control.chipHeight;

export const chipRecipe = {
  slots: ["root", "leading", "indicator", "label", "trailing"] as const,
...
export const listRecipe = {
  slots: ["root", "item", "separator"] as const,
...
export const accordionRecipe = {
  slots: ["root", "item", "header", "trigger", "title", "indicator", "panel", "divider"] as const,
...
export const menuRecipe = {
  ...
  leading: { color: ColorReference; glyph: GlyphSize };
  shortcut: { color: ColorReference; textVariant: TextVariant };
  indicator: { color: ColorReference; glyph: GlyphSize };
  separator: ColorReference;
  dangerIndicator: {
    color: ColorReference;
    glyph: GlyphSize;
    mark: "alert";
...
export type MenuDensity = keyof typeof menuRecipe.density;

export type SelectSize = "medium" | "large";
export type SelectDensity = "compact" | "comfortable";
...
export const selectRecipe = {
  ...
  slots: readonly string[];
  defaults: { size: SelectSize; density: SelectDensity };
  adaptive: { web: "popover"; native: "sheet" };
  ...
  value: { color: ColorReference; placeholderColor: ColorReference; gap: number };
  leading: { color: ColorReference };
  indicator: { color: ColorReference };
  busyIndicator: { color: ColorReference; glyph: GlyphSize };
  ...
  states: {
    ...
    pressedBackground: ColorReference;
    focus: typeof focusIndicatorContract;
    invalidBorder: ColorReference;
    disabledOpacity: number;
  };
  transition: {
    web: { enter: typeof motionPreset.micro; exit: typeof motionPreset.exit };
    native: { enter: typeof motionPreset.enter; exit: typeof motionPreset.exit };
  };
};
...
export const comboboxRecipe = {
  ...
  slots: readonly string[];
  defaults: typeof selectRecipe.defaults;
  adaptive: typeof selectRecipe.adaptive;
  frame: typeof selectRecipe.frame;
  sizes: typeof selectRecipe.sizes;
  support: typeof selectRecipe.support;
  input: typeof selectRecipe.value;
  leading: typeof selectRecipe.leading;
  indicator: typeof selectRecipe.indicator;
  clear: { diameter: number; hitSlop: number; glyph: GlyphSize; color: ColorReference };
  loadingIndicator: { color: ColorReference; glyph: GlyphSize };
  popover: typeof selectRecipe.popover;
  density: typeof selectRecipe.density;
  sectionLabel: typeof selectRecipe.sectionLabel;
  optionLeading: typeof selectRecipe.optionLeading;
  optionLabel: typeof selectRecipe.optionLabel;
  selectionIndicator: typeof selectRecipe.selectionIndicator;
  stateMessage: typeof selectRecipe.stateMessage;
  states: typeof selectRecipe.states;
  transition: typeof selectRecipe.transition;
};
...
export const bottomNavigationRecipe = {
  ...
  presentations: {
    bar: {
      ...
      border: semanticColors.border.default,
      borderWidth: stroke.default,
      borderEdges: ["block-start"] as const,
      radius: null,
      shadow: null,
      maxWidth: null,
  ...
  states: {
    ...
    selectedNonColorEvidence: {
      target: "icon-and-label" as const,
      label: "font-weight" as const,
      icon: "emphasis" as const,
    },
    selectedFocusSeparation: {
      selectedTarget: "icon-and-label" as const,
      focusTarget: "item",
...
export const tabsRecipe = {
  slots: ["root", "list", "tab", "label", "indicator", "panel"] as const,
...
export type NoticeTone = "info" | "success" | "warning" | "attention" | "danger";

export const noticeRecipe = {
  slots: ["root", "icon", "content", "title", "description", "action"] as const,
  defaults: { tone: "info" },
  tones: {
...
export const skeletonRecipe = {
  slots: ["root"] as const,
  // animated는 0.9.12까지 false였다. 정지한 블록은 로딩이 아니라 깨진 화면으로
...
export type LoadMoreDensity = "compact" | "regular";
...
export const loadMoreRecipe = {
  ...
  slots: readonly string[];
  defaults: { mode: "automatic" | "manual"; density: LoadMoreDensity };
  density: Record<LoadMoreDensity, { paddingVertical: number; gap: number }>;
  status: { color: ColorReference; textVariant: TextVariant };
  error: { color: ColorReference; textVariant: TextVariant };
  end: { color: ColorReference; textVariant: TextVariant };
  trigger: {
    minHeight: number;
    paddingHorizontal: number;
...
export type StatisticDensity = "compact" | "comfortable";
export type StatisticPresentation = "plain" | "surface";
...
export const sheetRecipe = {
  slots: ["backdrop", "positioner", "content", "handle", "header", "title", "body", "footer", "close"] as const,
...
export const dialogRecipe = {
  slots: ["backdrop", "positioner", "content", "header", "title", "description", "body", "footer", "close"] as const,
...
export const alertDialogRecipe = {
  ...
  slots: readonly string[];
  defaults: { tone: AlertDialogTone; size: DialogSize };
  sizes: typeof dialogRecipe.sizes;
  backdrop: typeof dialogRecipe.backdrop;
  content: typeof dialogRecipe.content;
  tones: Record<
    AlertDialogTone,
    {
      icon: ColorReference;
      iconBackground: ColorReference;
      confirm: ColorReference;
      confirmContent: ColorReference;
    }
  >;
...
export const toastRecipe = {
  ...
  slots: readonly string[];
  defaults: { tone: ToastTone; placement: ToastPlacement; durationMs: number };
  adaptive: { web: "fixed-viewport"; native: "safe-area-overlay" };
  viewport: {
    layer: number;
    gap: number;
  ...
  placements: Record<
    ToastPlacement,
    {
      blockEdge: "top" | "bottom";
      inlineEdge: "start" | "center" | "end";
      stackFrom: "top" | "bottom";
    }
  >;
  tones: Record<
    ToastTone,
    { foreground: ColorReference; accent: ColorReference; mark: ToastToneMark }
  >;
  surface: {
    ...
    borderWidth: number;
    radius: keyof typeof radius;
    shadow: typeof floatingSurfaceContract.shadow;
    minHeight: number;
    padding: number;
    gap: number;
    maxWidth: number;
  ...
  close: { color: ColorReference; diameter: number; glyph: GlyphSize };
  states: {
    pressedOpacity: number;
    draggedOpacity: number;
    focus: typeof focusIndicatorContract;
  };
  gesture: { dismissThreshold: number };
  transition: {
    web: { enter: typeof motionPreset.micro; exit: typeof motionPreset.exit };
    native: { enter: typeof motionPreset.enter; exit: typeof motionPreset.exit };
  };
...
export const tooltipRecipe = {
  slots: ["provider", "trigger", "content", "arrow"] as const,
...
export const bottomCtaRecipe = {
  slots: ["root", "description", "secondaryAction", "primaryAction"] as const,
  minHeight: 64,
...
export const sectionRecipe = {
  slots: ["root", "header", "copy", "title", "description", "action", "content"] as const,
  gap: spacing.xs,
...
export type TabSize = keyof typeof tabsRecipe.sizes;
export type TabsLayout = keyof typeof tabsRecipe.layouts;
export type TabsOverflow = keyof typeof tabsRecipe.overflow;
export type SpinnerSize = keyof typeof spinnerRecipe.sizes;
export type SpinnerTone = keyof typeof spinnerRecipe.tones;
export type AvatarSize = keyof typeof avatarRecipe.sizes;
export type AvatarShape = keyof typeof avatarRecipe.shapes;
export type DialogSize = keyof typeof dialogRecipe.sizes;
